...
function sourceFromSessionRecord(record, threadId, sessionId) {
    const body = payload(record);
...
export function findCodexSessionFile(sessionId, env = process.env) {
...
export function readSessionSources(args) {
